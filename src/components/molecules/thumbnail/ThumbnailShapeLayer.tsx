...
export interface ThumbnailShapeLayerProps {
  layer: {
    id: string;
    type: 'shape';
    x: number;
...
export const ThumbnailShapeLayer: React.FC<ThumbnailShapeLayerProps> = ({ 
  layer, 
  isSelected, 
  onSelect, 
  onChange 
  ...
  const handleTransformEnd = () => {
    ...
    onChange({
      ...
      x: node.x(),
      y: node.y(),
      scaleX: layer.scaleX * scaleX,
      scaleY: layer.scaleY * scaleY,
