...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-blue-500 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-blue-600 text-blue-400-foreground shadow hover:bg-blue-600/90",
        destructive:
          "bg-red-600 text-red-400-foreground shadow-sm hover:bg-red-600/90",
        outline:
          "border border-gray-700 bg-gray-900 shadow-sm hover:bg-gray-700 hover:text-white",
        secondary:
          "bg-gray-700 text-white shadow-sm hover:bg-gray-700/80",
